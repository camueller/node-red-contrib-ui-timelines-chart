...
helper.init(require.resolve('node-red'), {// functionGlobalContext: { fs:require('fs') }
});
describe("ui_timelines_chart Node", function () {
  ...
  const TEST_CASE_OK = "TEST_CASE_OK"; // enable tests
  ...
  if (BASIC_TEST_BOOLEAN) {
          ...
          try {
            ...
            switch (_testCase) {
              case TEST_CASE_OK:
                ...
                _n1.warn.should.be.not.calledWithExactly(_warnText);
                /* not warning */
              ...
              case TEST_CASE_NG:
                ...
                _n1.warn.should.be.calledWithExactly(_warnText);
                /* warning */
    ...
    describe("basic test numbar", function () {
      this.timeout(10000); // enableAnimations
      ...
      basicTestBoolean('enableAnimations', d.myConst.items.enableAnimations.default, null, TEST_CASE_NG); // enableDateMarker
      ...
      basicTestBoolean('enableDateMarker', d.myConst.items.enableDateMarker.default, null, TEST_CASE_NG); // forwardInputMessages
  ...
  if (BASIC_TEST_NUMBER) {
    ...
    function basicTestNumber(_valueName, _default, _valueMin, _valueMax, _testCase) {
      // test case
      const _testCaseNumber = [_valueMin, Math.round((_valueMax - _valueMin) / 2), _valueMax, _valueMin - 1, _valueMax + 1, "", "string", null, undefined];
  ...
  if (BASIC_TEST_STRING) {
    ...
    describe("basic test string", function () {
      this.timeout(10000); // xTickFormat case1:true, case2:false
      ...
      basicTestString('xTickFormat', d.myConst.items.xTickFormat.default, undefined, TEST_CASE_NG); // xAxisLabelslColor case1:true, case2:false
      ...
      basicTestString('xAxisLabelslColor', d.myConst.items.xAxisLabelslColor.default, undefined, TEST_CASE_NG); // yAxisLabelslColor case1:true, case2:false
      ...
      basicTestString('yAxisLabelslColor', d.myConst.items.yAxisLabelslColor.default, undefined, TEST_CASE_NG); // resetZoomLabelColor case1:true, case2:false
  ...
  if (BASIC_TEST_DATETIME) {
          ...
          try {
            ...
            switch (_testCase) {
              case TEST_CASE_OK:
                ...
                _n1.error.should.be.not.calledWithExactly(_warnText);
                /* not error */
              ...
              case TEST_CASE_NG:
                ...
                _n1.error.should.be.calledWithExactly(_warnText);
                /* error */
    ...
    describe("basic test datetime", function () {
      this.timeout(10000); // startDateTime
      ...
      for (let _i = 0; _i < 128; ++_i) {
        ...
        const _testValue = `${_Y}-${_M}-${_D} ${_h}:${_m}:${_s}`; // console.log(_test);
